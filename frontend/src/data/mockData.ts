...
export const MOCK_USERS: Array<AuthenticatedUser & { username: string; password: string }> = [
  {
    id: 6,
    nama: 'Admin MedikaScale',
    username: 'admin',
    password: 'demo123',
    role: { id: 5, kode: 'admin', nama_tampil: 'Administrator' },
    permissions: [
      ...
      'resep.view', 'resep.kirim', 'resep.proses', 'resep.create', 'resep.send', 'resep.process', 'resep.complete', 'resep.cancel',
      'pemeriksaan.view', 'pemeriksaan.create', 'pemeriksaan.process', 'pemeriksaan.review',
      'lab.kelola', 'sophi.view', 'vaksin.view', 'tumbuh_kembang.view', 'denver_ii.view', 'konsultasi_makan.view',
    ],
  },
  {
    id: 1,
  ...
  },
  {
    ...
    permissions: ['resep.proses', 'resep.view', 'resep.process', 'resep.complete', 'resep.cancel', 'arsip.view'],
  },
  {
    id: 4,
    ...
    permissions: ['lab.kelola', 'pemeriksaan.view', 'pemeriksaan.process', 'pemeriksaan.create', 'arsip.view'],
  },
  {
    id: 5,
    nama: 'Siti Rahma, A.Md.RMIK',
    username: 'arsiparis',
    password: 'demo123',
    role: { id: 6, kode: 'arsiparis', nama_tampil: 'Arsiparis' },
    permissions: ['arsip.view', 'arsip.manage', 'arsip.pinjam', 'arsip.kembalikan', 'arsip.minta_pengiriman'],
  },
];
