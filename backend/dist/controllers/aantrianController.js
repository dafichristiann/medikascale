...
export async function getKunjunganList(req, res) {
    try {
        const filters = {
            poli: req.query.poli,
...
export async function getKunjunganDetail(req, res) {
    try {
...
export async function updateKunjunganStatus(req, res) {
    try {
        ...
        const result = await aantrianService.updateKunjunganStatus(parseInt(req.params.id, 10), statusBaru, prioritas, req.user.id);
        try {
...
export async function getAantrianLog(req, res) {
    try {
...
//# sourceMappingURL=aantrianController.js.map